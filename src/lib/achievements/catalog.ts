...
export const ACHIEVEMENT_CATALOG: AchievementDef[] = [
  ...
  },
  {
    slug: "runner",
    name: "Signal Scout",
    description: "Reach 50% progress on VOID SIGNAL.",
    icon: "footprints",
    xp_reward: 100,
    game_slug: "void-runner",
    check: (m) => (m.progress ?? 0) >= 50 || (m.distance ?? 0) >= 3500,
  },
  {
    slug: "coin-collector",
    name: "Gem Runner",
    description: "Collect 5 gems in a Void Runner clear.",
    icon: "coins",
    xp_reward: 75,
    game_slug: "void-runner",
    check: (m) => (m.collectibles ?? m.coins ?? 0) >= 5,
  },
  {
